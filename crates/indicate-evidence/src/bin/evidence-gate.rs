...
use indicate_evidence::gate::{FindingCode, validate, validate_resolving};
use indicate_evidence::policy::Policy;
use indicate_evidence::{EvidenceError, NodeId, impact, parse, report, trace};
...
fn resolvable_exit(gate_report: &indicate_evidence::gate::GateReport) -> ExitCode {
