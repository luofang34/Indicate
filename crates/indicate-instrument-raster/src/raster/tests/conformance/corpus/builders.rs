...
use indicate_instrument_scene::{Anchor, LayerId, PaintMode, Rgba8};
...
fn every_opcode(w: &mut indicate_instrument_scene::SceneWriter<'_>) {
...
fn multi_layer(w: &mut indicate_instrument_scene::SceneWriter<'_>) {
