...
//! [`validate_layers`](indicate_instrument_scene::validate_layers) exactly as
...
use indicate_instrument_scene::{Anchor, Cmd, PaintMode, PointsRef, SceneCmds, validate_layers};
