...
//! adding `v9` fails the generator instead of silently pinning `v8`
...
use indicate_instrument_state::abi::v8::VERSION;

use crate::error::XtaskError;

/// The module this generator reads [`VERSION`] from.
const COMPILED_MODULE: u32 = 8;
