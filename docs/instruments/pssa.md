...
| Compositor (FC-CMP-01–03) | [`AIR-HAZ-004`](requirements.md#air-haz-004), [`AIR-BAS-007`](requirements.md#air-bas-007), [`AIR-OUT-011`](requirements.md#air-out-011) | [#25](https://github.com/luofang34/Pilotage/issues/25), [#30](https://github.com/luofang34/Pilotage/issues/30) |
